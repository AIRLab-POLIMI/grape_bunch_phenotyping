"""
The following code has been copied from a comment appeared on this GitHub
issue: https://github.com/facebookresearch/detectron2/issues/3054
The author of the code is the GitHub user KUASWoodyLIN
"""
import numpy as np
